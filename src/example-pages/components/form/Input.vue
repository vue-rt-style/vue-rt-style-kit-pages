...
<!--&lt;!&ndash;							<span class="rt-font-label flex-fill rt-space-bottom05">simple input</span>&ndash;&gt;-->
...
<!--              <rt-input :version="2" placeholder="Поле ввода с иконкой" label="Эта иконка ничего не делает">-->
<!--                <template slot="icon">-->
<!--                  <rt-system-icons name="atom"/>-->
<!--                </template>-->
<!--              </rt-input>-->
...
<!--              </rt-input>-->
<!--&lt;!&ndash;							<pre-code text="<rt-input label=&quot;Начните вводить почту&quot;&ndash;&gt;-->
<!--&lt;!&ndash;                              type=&quot;string&quot;&ndash;&gt;-->
<!--&lt;!&ndash;                              value=&quot;&quot;&ndash;&gt;-->
<!--&lt;!&ndash;                              placeholder=&quot;Электронная почта&quot; />"/>&ndash;&gt;-->
<!--						</div>-->
...
<!--                        :min-number="0"-->
<!--                        :max-number="99"-->
<!--                        placeholder="Введите целое число в диапазоне 0 - 99"/>-->
<!--              <rt-input label="Переключение видимости по нажатию на иконку"-->
<!--                        :version="2"-->
<!--                        type="text"-->
...
<!--            </div>-->
<!--            <div class="rt-col-1 md-d-none"/>-->
<!--&lt;!&ndash;						<div class="rt-col-4 rt-col-md-2 rt-md-space-top">&ndash;&gt;-->
<!--&lt;!&ndash;							<span class="rt-font-label flex-fill rt-space-bottom05">input with error</span>&ndash;&gt;-->
<!--&lt;!&ndash;							<pre-code text="<rt-input type=&quot;email&quot;&ndash;&gt;-->
<!--&lt;!&ndash;                              label=&quot;Начните вводить почту&quot;&ndash;&gt;-->
<!--&lt;!&ndash;                              placeholder=&quot;Электронная почта&quot;&ndash;&gt;-->
<!--&lt;!&ndash;                              value=&quot;inputModelValue&quot;&ndash;&gt;-->
<!--&lt;!&ndash;                              error-message=&quot;ошибка: не является почтой&quot;&ndash;&gt;-->
<!--&lt;!&ndash;                              :has-error=&quot;true&quot; />"/>&ndash;&gt;-->
<!--&lt;!&ndash;						</div>&ndash;&gt;-->
<!--&lt;!&ndash;						<div class="rt-col-4 rt-col-md-1 rt-md-space-top">&ndash;&gt;-->
<!--&lt;!&ndash;							<span class="rt-font-label flex-fill rt-space-bottom05">disabled input</span>&ndash;&gt;-->
<!--&lt;!&ndash;							<pre-code text="<rt-input value=&quot;&quot;&ndash;&gt;-->
<!--&lt;!&ndash;                              placeholder=&quot;Электронная почта&quot;&ndash;&gt;-->
...
<!--					</div>-->
					...
					<div class="app-row row rt-space-top rt-space-bottom ">
						...
						<div class="rt-col rt-col-4 rt-col-td-3 rt-col-md-3">
							<pre-code text="<rt-input placeholder=&quot;Электронная почта&quot;
                              :hasError=&quot;true&quot;
                              :is-b2b-input=&quot;true&quot;
                              value=&quot;kdbaf@dfj.dfd&quot;
					...
					<div class="app-row row">
						<div class="rt-col rt-col-6 rt-col-td-3 rt-col-md-3">
							...
							<pre-code text="<rt-input placeholder=&quot;Электронная почта&quot;
                              ...
                              :is-b2b-input=&quot;true&quot;
                              :outlined=&quot;true&quot;/>"/>
							<pre-code text="<rt-input placeholder=&quot;Введите пароль&quot;
                              type=&quot;password&quot;
                              :is-b2b-input=&quot;true&quot;
                              :outlined=&quot;true&quot;/>"/>
						</div>
					...
					<div class="app-row color-block--light-grey rt-space-top3 rt-space-bottom3 row">
						...
						<div class="rt-col rt-col-6 rt-col-td-4 rt-col-md-3">
							...
							<rt-input placeholder="Электронная почта" :is-b2b-input="true" :input-button="true"
							...
							<rt-button class="rt-button-transparent-purple">
								Получить код
							</rt-button>
						</div>
						<div class="rt-col-3 rt-col-td-1"/>
