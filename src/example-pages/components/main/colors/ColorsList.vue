<script type="text/jsx">
    ...
    import ColorItem from "./ColorsListItem.vue";
    import colors from "@vue-rt-style-kit-atoms-local/colorFullDocs.json";
    ...
    export default {
        ...
        methods: {
            ...
            convertToRGBAToHex(rgba) {
                const color = rgba.replace(/(rgba\()|(\))|( )/g, "").split(",").map((number) => {
                    number = number - 0;
                    if (number % 1 === 0) {
