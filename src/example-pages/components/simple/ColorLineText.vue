        ...
        <div class="app-content  rt-col-12 rt-col-md-3">
            ...
            <div class="app-body">
                <div class="app-row row color-block--dark-blue">
                    <div class="rt-space-horizontal rt-space-vertical rt-col">
                        <rt-color-line-text label-color="blue">
                            <template slot="label">Будьте спокойны за <br> своих близких</template>
                        </rt-color-line-text>
                    </div>
                </div>
                <pre-code text='<div class="app-row row color-block--dark-blue"><div class="rt-space-horizontal rt-space-vertical rt-col"><rt-color-line-text label-color="blue" :hide-arrow="true"><template slot="label">Будьте спокойны</template></rt-color-line-text></div></div>'/>
                ...
                <pre-code text="<div class='app-row row'><div class='rt-space-horizontal rt-space-vertical'><rt-color-line-text :is-white-color='true' color-icon='green' fill-color='pink'><template slot='label'>Мама мыла раму!</template></rt-color-line-text></div></div>"/>
