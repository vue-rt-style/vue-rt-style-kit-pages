        ...
        <div class="app-body">
          <div class="sp-b-2">
            ...
            <rt-annotation scroll-timeout={1000} v2={true} is-only-one-open={false}>
              ...
              <template slot="content">
                <p class="rt-font-small-paragraph">ОС Аврора — первая и пока единственная российская операционная
                  система,
                  которая позволяет удаленно контролировать процесс обработки данных на мобильных устройствах.</p>
              </template>
            </rt-annotation>
            <rt-annotation scroll-timeout={1000} v2={true}>
              <template slot="label">В чем преимущества работы операционной системы «Аврора» и почему важно
                формирование доверенной мобильной среды в крупной компании?
              </template>
              <template slot="content">
                <p class="rt-font-small-paragraph">У операционной системы «Аврора» есть ряд преимуществ, которые
                  ...
                  документооборота и корпоративном облаке с использованием электронной подписи. Основные преимущества ОС
                  Аврора:</p>
                <ul class="rt-numeric-list sp-v-1">
                  ...
                  <li class="rt-numeric-list__item">
                    ...
                    <ul class="rt-ordered-list sp-t-1">
                      <li class="rt-ordered-list__item rt-font-small-paragraph">Защищенный доступ с мобильных устройств
                        к ИС и БД
                      </li>
                      <li class="rt-ordered-list__item rt-font-small-paragraph">Централизованное управление и
                        администрирование устройств
                      </li>
                      <li class="rt-ordered-list__item rt-font-small-paragraph">Удалённая работа с конфиденциальной
                        информацией
                      </li>
                    </ul>
                  </li>
