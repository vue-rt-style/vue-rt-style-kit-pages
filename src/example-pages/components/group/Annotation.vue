  ...
  <div class="rt-container">
    <div class="app-content rt-col-12 rt-col-md-3">
      ...
      <div class="app-body">
        <div class="row">
          <div class="rt-col-7">
            <pre-code text="<rt-annotation hash='open' :scroll-timeout='1000' :v2='true' :open='true'>
          ...
          <div class="rt-col-5">
            <rt-annotation hash='open' :scroll-timeout='1000' :v2='true'>
              <template slot='label'>Примечание<br>Примечание</template>
              <template slot='content'>
                <div class='rt-numeric-list'>
                  <p class='rt-numeric-list__item'>Услуги Высокоскоростного интернета предоставляются при наличии
                    технической возможности.</p>
                  <p class='rt-numeric-list__item'>Цены указаны в рублях с учетом НДС.</p>
                  <p class=''> «По оптической линии» — предоставление доступа к сети Интернет
                    осуществляется по технологии FTTx (англ., fiber to the x — оптическое волокно до точки X)
                    или по технологии PON (англ. Passive Optical Networks — пассивная оптическая сеть до
                    абонента).</p>
                  <p class=''> «По телефонной линии» — предоставление доступа к сети Интернет
                    осуществляется по технологии xDSL (англ., digital subscriber line, цифровая абонентская
                    линия).</p>
                  <p class='rt-numeric-list__item'>Предоставление доступа к сети Интернет осуществляется по технологии
                    xDSL (англ., digital subscriber line, цифровая абонентская линия).</p>
                </div>
              </template>
            </rt-annotation>
