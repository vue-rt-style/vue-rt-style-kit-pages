<template>
  <div class="blog blog-main">
      ...
      <div class="blog-container">
        <div class="rt-col">
          <div class="row">
            ...
            <div class="rt-col-2 rt-col-td-2 rt-col-md-3 flex-end-bottom md-flex-start-bottom md-sp-t-0-3">
              <rt-select-v2 :json="optionsList" name="test99" :set-first-active="true"></rt-select-v2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="blog__page-wrapper sp-t-2 sp-b-3 td-sp-t-1-3 md-sp-b-2 md-sp-t-1-1">
          ...
          <div class="row">
            <div class="rt-col-8 sp-b-3 rt-col-td-6 md-sp-b-2">
              <a href="/tv" class="blog__weekly-theme-wrapper">
                ...
                <div class="blog__weekly-theme__bottom">
                  <div class="blog__description color-white07 rt-font-label flex-start-center color-md-main05 md-sp-t-0-2">
                    <span class="blog__weekly-theme__date">12 марта</span>
                    <span class="blog__weekly-theme__ttr flex-center-center sp-l-0-3">
                      <rt-system-icons name="time small" color="white07"/>
                      5 минут чтения
                    </span>
            ...
            <div class="rt-col-4 sp-b-3 rt-col-td-6 td-sp-b-0-4 md-sp-b-none">
              <div class="flex-start-center td-sp-b-0-2 md-sp-b-0-1">
                ...
                <span class="rt-font-h4 sp-l-0-2">Популярное</span>
              </div>
          ...
          <div class="row sp-b-3 blog__article-tile td-sp-b-2-1 md-sp-b-1-1">
            <div class="rt-col-4 rt-col-td-6">
              <div class="blog__article-tile__item td-sp-v-0-4">
                <div class="row">
                  <div class="rt-col-12 rt-col-td-3 rt-col-md-3">
                    <div class="blog__article-tile__image-wrapper d-flex">
                  ...
                  <div class="rt-col-12 rt-col-td-3 rt-col-md-3">
                    ...
                    <a href="#" class="font-h-l">Как помочь ребенку освоить <br>школьную программу</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="blog__article-tile__item td-sp-v-0-4">
                <div class="row">
                  ...
                  <div class="rt-col-12 rt-col-td-3 rt-col-md-3">
                    ...
                    <a href="#" class="font-h-l">Пять лучших приложений для <br>обработки фотографий</a>
                  </div>
                  </div>
              </div>
            </div>
              ...
              <div class="blog__article-tile__item td-sp-v-0-4">
                <div class="row">
                  ...
                  <div class="rt-col-12 rt-col-td-3 rt-col-md-3">
                    ...
                    <a href="#" class="font-h-l">Сколько раз можно менять <br>мобильного оператора </a>
                  </div>
                  </div>
              </div>
            </div>
      ...
      <div class="sp-b-3 md-sp-b-2">
        <div class="blog__manual-wrapper">
          <div class="blog-container">
            <div class="rt-col">
              ...
              <div class="blog__article-tile__item td-sp-v-0-4">
                <div class="row">
                  ...
                  <div class="rt-col-12 rt-col-td-3 rt-col-md-3">
                    ...
                    <a href="#" class="font-h-l">Как понять, что ноутбук или телефон устарел</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="blog__article-tile__item td-sp-v-0-4">
                <div class="row">
                  ...
                  <div class="rt-col-12 rt-col-td-3 rt-col-md-3">
                    ...
                    <a href="#" class="font-h-l">Зачем покупать “красивый” <br>телефонный номер</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="blog__article-tile__item td-sp-v-0-4">
                <div class="row">
                  ...
                  <div class="rt-col-12 rt-col-td-3 rt-col-md-3">
                    ...
                    <a href="#" class="font-h-l">Три важных налоговых нововведения в <br>2021 году</a>
                  </div>
                </div>
              </div>
            </div>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        optionsList: [{value: 'all', label: 'Для всех'}, {value: 'b2b', label: 'Для меня'}, {value: 'b2c', label: 'Для бизнеса'}],
        hintArray: [],
        hintCardMaxHeight: 0
      }
    },
    ...
    methods: {
      ...
      refreshHint() {
        ...
        let lastElem = this.hintArray.shift();
        this.hintArray.push(lastElem)
        setTimeout(() => {
          this.hintArray[this.hintArray.length - 1].classList.remove('blog__hint-carousel__item--hidden');
        },350)
      },
