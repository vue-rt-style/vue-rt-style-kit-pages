<template>
  <div>
    <div class="color-block--dark-slate" style="height: 2000px"></div>
    <div class="wc-inline">
          ...
          <rt-col>
            <rt-row v-rt-resize-content-height="{querySelectorsNames: '.scroll-slider-content'}">
                ...
                <div class="scroll-slider-item d-flex flex-v-center td-sp-t-3">
                  <div class="rt-col">
                    <div class="row td-flex-column-reverse">
                      <h2 class="td-sp-t-2 scroll-slider-title rt-font-h2"><span class="color-orange">Вы сможете</span>
                        фиксировать
              ...
              <rt-col size="6" :t-hide="true">
                <div class="scroll-slider-image d-flex flex-v-center"></div>
              </rt-col>
    ...
    <div class="color-block--dark-slate" style="height: 400px"></div>
  </div>
</template>
<!--ld-key-gray-->
<script>
