<template>
  <div>
    <div class="wc-inline">
      <div class="ld-key">
      <div class="lg-sp-b-4">
        <rt-jumbotron background='main-color003-no-opacity' color="main" description-color="main"
                      :desktop-column-size="5">
          ...
          <template slot='image'>
            <rt-img src='https://static-cdn.rt.ru/sites/default/files/img/rt-key/banner.jpg'
                    x2-src='https://static-cdn.rt.ru/sites/default/files/img/rt-key/banner-x2.jpg'
            ></rt-img>
          </template>
          <template slot="footer">
            <rt-button color="purple" v-rt-scroll-to-on-click='{"scrollToId": "form"}'>Подать заявку</rt-button>
          </template>
        </rt-jumbotron>
      </div>
    </div>
    ...
    <div class="wc-inline">
      <div class="ld-key ld-key-slader-block sp-v-4 td-sp-v-3 md-sp-v-2">
      <div class="rt-container">
        <rt-col>
          <rt-row>
            <rt-col :size="2" :tablet-size="6">
              <div class="ld-key-tabs sp-b-4 td-sp-b-none">
                <div class="ld-key-tabs-nav td-d-flex">
                  <div
                      class="ld-key-tabs-nav-item td-d-flex sp-l-0-4 sp-t-0-3 sp-r-0-4 sp-b-0-2 td-sp-h-0-3 td-sp-v-0-3 ld-key-tabs-nav-item--active"
                      data-index="0">
                    <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                         class="ld-key-tabs-nav-icon">
                    ...
                    <p class="ld-key-table-label sp-t-0-4 td-d-none">Умный домофон</p>
                  </div>
                  <div class="sp-t-1-1 td-sp-t-none td-sp-l-0-4">
                    <div
                        class="ld-key-tabs-nav-item td-d-flex ld-key-tabs-nav-item-puprle sp-l-0-4 sp-t-0-3 sp-r-0-4 sp-b-0-2 td-sp-h-0-3 td-sp-v-0-3"
                        data-index="1">
                      <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                           class="ld-key-tabs-nav-icon">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                      ...
                      <p class="ld-key-table-label sp-t-0-4 td-d-none">Комплексное видеонаблюдение</p>
                    </div>
                  </div>
                  <div class="sp-t-1-1 td-sp-t-none td-sp-l-0-4">
                    <div
                        class="ld-key-tabs-nav-item td-d-flex ld-key-tabs-nav-item-dark sp-l-0-4 sp-t-0-3 sp-r-0-4 sp-b-0-2 td-sp-h-0-3 td-sp-v-0-3"
                        data-index="2">
                      <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                           class="ld-key-tabs-nav-icon">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                      ...
                      <p class="ld-key-table-label sp-t-0-4 td-d-none">Умный шлагбаум</p>
                    </div>
                  </div>
                  <div class="sp-t-1-1 td-sp-t-none td-sp-l-0-4">
                    <div
                        class="ld-key-tabs-nav-item td-d-flex ld-key-tabs-nav-item-gray sp-l-0-4 sp-t-0-3 sp-r-0-4 sp-b-0-2 td-sp-h-0-3 td-sp-v-0-3"
                        data-index="3">
                      <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                           class="ld-key-tabs-nav-icon">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                      ...
                      <p class="ld-key-table-label sp-t-0-4 td-d-none">Умные счетчики</p>
                    </div>
                  </div>
                  <div class="sp-t-1-1 td-sp-t-none td-sp-l-0-4">
                    <div
                        class="ld-key-tabs-nav-item td-d-flex ld-key-tabs-nav-item-green sp-l-0-4 sp-t-0-3 sp-r-0-4 sp-b-0-2 td-sp-h-0-3 td-sp-v-0-3"
                        data-index="4">
                      <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                           class="ld-key-tabs-nav-icon">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                      ...
                      <p class="ld-key-table-label sp-t-0-4 td-d-none">Умный доступ</p>
                    </div>
                  </div>
                </div>
              </div>
            </rt-col>
            <rt-col :size="10" :tablet-size="6">
              <div class="ld-key-tabs-content">
                <div class="ld-key-tabs-item ld-key-tabs-item--active">
                  <rt-row class="td-sp-t-2 row-md-reverse">
                    <div class="rt-col-persent-6 rt-col-td-4 rt-col-md-3 td-sp-r-3 md-sp-r-none">
                      <div class="sp-l-2-2 sp-t-2 td-sp-t-none td-sp-l-none md-sp-t-1-4 rt-font-small-paragraph">
                        <p class="rt-font-center color-purple rt-link ld-key-tab-show-more md-d-block d-none">Узнать
                          больше</p>

                        <div class="ld-key-tab-content sp-r-2-4 td-r-1 md-sp-r-none">
                          <p class="rt-font-h2 md-d-none">Умный домофон — новые возможности вашего комфорта</p>
                          <p class="sp-t-1-1">Умный домофон — это вход без ключей, ответ на звонок в квартиру из любой
                            точки
                            города, а также удаленное управление доступом через приложение на вашем смартфоне.</p>
                          <div class="sp-t-2"><p class="ld-key-boolet">Прием аудио- и видеовызова, дистанционное
                            открытие
                            двери из любой точки
                            через
                            приложение </p></div>
                          <div class="sp-t-1"><p class="ld-key-boolet">Управление доступом: создание постоянных ключей
                            для
                            семьи и временных кодов
                            для
                            курьеров и гостей</p></div>
                          <div class="sp-t-1"><p class="ld-key-boolet">Автоматическая переадресация звонка из приложения
                            при
                            отсутствии интернета
                            на
                            мобильный или
                            стационарный телефон</p></div>
                          <p class="rt-font-center color-purple rt-link ld-key-tab-show-less md-d-none d-none md-sp-t-1-1">Скрыть</p>
                        </div>
                      </div>
                    </div>
                    <div label="Умный домофон — новые возможности вашего комфорта"
                         data-tab-index="0"
                         class="rt-col-persent-4 rt-font-center rt-col-td-2 rt-col-md-3 ld-key-tabs-slider">

                      <div class="ld-key-tabs-slider-wrapper md-sp-t-1-1">
                        <div class="ld-key-tabs-slider-container sp-h-0-3 md-sp-h-2">
                          <div class="ld-key-tabs-slider-item ld-key-tabs-slider-item--active">
                            <p class="ld-key-slider-text">Домофон с функцией видеозвонков</p>
                            <img
                                src="https://static-cdn.rt.ru/sites/default/files/img/rt-key/intercom-1.png" alt="">
                          </div>
                          <div class="ld-key-tabs-slider-item">
                            <p class="ld-key-slider-text">Удаленное открытие</p>
                            <img
                                src="https://static-cdn.rt.ru/sites/default/files/img/rt-key/intercom-2.png" alt="">
                          </div>
                          <div class="ld-key-tabs-slider-item">
                            <p class="ld-key-slider-text">Временные коды для гостей</p>
                            <img
                                src="https://static-cdn.rt.ru/sites/default/files/img/rt-key/intercom-3.png" alt="">
                          </div>
                        </div>
                        <div class="ld-key-tabs-paginator d-flex sp-t-1-2 md-d-none">
                          <div data-tab-index="0" data-slide-index="0"
                               class="ld-key-tabs-paginator-item ld-key-tabs-paginator-item--active flex-fill"></div>
                          <div data-tab-index="0" data-slide-index="1"
                               class="ld-key-tabs-paginator-item flex-fill"></div>
                          <div data-tab-index="0" data-slide-index="2"
                               class="ld-key-tabs-paginator-item flex-fill"></div>
                        </div>
                        <div class="ld-key-tabs-arrows d-flex sp-t-1-2 md-d-block d-none">
                          <div data-tab-index="0" class="ld-key-tabs-arrows-left ld-key-tabs-arrows-item">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M8.47115 11.4692L13.9711 5.99976L15.0289 7.06337L10.0636 12.001L15.0289 16.9387L13.9711 18.0023L8.47115 12.5328C8.32959 12.392 8.25 12.2007 8.25 12.001C8.25 11.8014 8.32959 11.61 8.47115 11.4692Z"
                                    fill="#101828"/>
                            </svg>

                          </div>
                          <div data-tab-index="0" class="ld-key-tabs-arrows-right ld-key-tabs-arrows-item">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M15.5581 11.4692L10.0581 5.99976L9.00045 7.06337L13.9657 12.001L9.00045 16.9387L10.0581 18.0023L15.5581 12.5328C15.6997 12.392 15.7793 12.2007 15.7793 12.001C15.7793 11.8014 15.6997 11.61 15.5581 11.4692Z"
                                    fill="#101828"/>
                            </svg>
                          </div>
                        </div>
                ...
                <div class="ld-key-tabs-item">
                  <rt-row class="td-sp-t-2 row-md-reverse">
                    <div class="rt-col-persent-6 rt-col-td-4 rt-col-md-3 td-sp-r-5 md-sp-r-none">
                      <div class="sp-l-2-2 sp-t-2 td-sp-t-none td-sp-l-none md-sp-t-1-4 rt-font-small-paragraph">
                        <p class="rt-font-center color-purple rt-link ld-key-tab-show-more md-d-block d-none">Узнать
                          больше</p>
                        <div class="ld-key-tab-content sp-r-2-4 td-r-1 md-sp-r-none">
                          <p class="rt-font-h2 md-d-none">Комплексное видеонаблюдение — новые возможности вашей
                            безопасности</p>
                          <p class="sp-t-1-1">Комплексное видеонаблюдение — это облачный сервис, который позволяет с
                            помощью
                            видеокамер осуществлять контроль за вашим двором и прилегающей территорией из любой точки
                            мира.</p>
                          <div class="sp-t-2"><p class="ld-key-boolet">Возможность видеоконтроля за общими зонами в доме
                            и
                            дворе </p></div>
                          <div class="sp-t-1"><p class="ld-key-boolet">Охрана объектов автотранспорта и контроль
                            парковки</p></div>
                          <div class="sp-t-1"><p class="ld-key-boolet">Наблюдение за детьми на детской площадке</p>
                          </div>
                          <div class="sp-t-1"><p class="ld-key-boolet">Видеофиксация фактов хулиганства, воровства и
                            иных
                            правонарушений</p></div>
                        </div>
                        <p class="rt-font-center color-purple rt-link ld-key-tab-show-less md-d-none d-none md-sp-t-1-1">Скрыть</p>
                      </div>
                    </div>
                    <div label="Комплексное видеонаблюдение — новые возможности безопасности для вашего
                        дома"
                         data-tab-index="1"
                         class="rt-col-persent-4 rt-font-center rt-col-td-2 rt-col-md-3 ld-key-tabs-slider">
                      ...
                      <div class="ld-key-tabs-slider-wrapper md-sp-t-1-1">
                        <div class="ld-key-tabs-slider-container sp-h-0-3 md-sp-h-2">
                          <div class="ld-key-tabs-slider-item ld-key-tabs-slider-item--active">
                            <p class="ld-key-slider-text">Смотрите видео онлайн</p>
                            <img
                                src="https://static-cdn.rt.ru/sites/default/files/img/rt-key/video-1.png" alt="">
                          </div>
                          <div class="ld-key-tabs-slider-item">
                            <p class="ld-key-slider-text">Архив записей до 7 дней </p>
                            <img
                                src="https://static-cdn.rt.ru/sites/default/files/img/rt-key/video-2.png" alt="">
                          </div>
                          <div class="ld-key-tabs-slider-item">
                            <p class="ld-key-slider-text">Съемка в темноте</p>
                            <img
                                src="https://static-cdn.rt.ru/sites/default/files/img/rt-key/video-3.png" alt="">
                          </div>
                        </div>
                        <div class="ld-key-tabs-paginator d-flex sp-t-1-2 md-d-none">
                          <div data-tab-index="1" data-slide-index="0"
                               class="ld-key-tabs-paginator-item ld-key-tabs-paginator-item--active flex-fill"></div>
                          <div data-tab-index="1" data-slide-index="1"
                               class="ld-key-tabs-paginator-item flex-fill"></div>
                          <div data-tab-index="1" data-slide-index="2"
                               class="ld-key-tabs-paginator-item flex-fill"></div>
                        </div>
                        <div class="ld-key-tabs-arrows d-flex sp-t-1-2 md-d-block d-none">
                          <div data-tab-index="1" class="ld-key-tabs-arrows-left ld-key-tabs-arrows-item">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M8.47115 11.4692L13.9711 5.99976L15.0289 7.06337L10.0636 12.001L15.0289 16.9387L13.9711 18.0023L8.47115 12.5328C8.32959 12.392 8.25 12.2007 8.25 12.001C8.25 11.8014 8.32959 11.61 8.47115 11.4692Z"
                          ...
                          <div data-tab-index="1" class="ld-key-tabs-arrows-right ld-key-tabs-arrows-item">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M15.5581 11.4692L10.0581 5.99976L9.00045 7.06337L13.9657 12.001L9.00045 16.9387L10.0581 18.0023L15.5581 12.5328C15.6997 12.392 15.7793 12.2007 15.7793 12.001C15.7793 11.8014 15.6997 11.61 15.5581 11.4692Z"
                  ...
                  <rt-row class="td-sp-t-2 row-md-reverse">
                    <div class="rt-col-persent-6 rt-col-td-4 rt-col-md-3 td-sp-r-5 md-sp-r-none">
                      <div class="sp-l-2-2 sp-t-2 td-sp-t-none td-sp-l-none md-sp-t-1-4 rt-font-small-paragraph">
                        ...
                        <div class="ld-key-tab-content sp-r-2-4 td-r-1 md-sp-r-none">
                          <p class="rt-font-h2 md-d-none">Умный шлагбаум — новые возможности вашего удобства</p>
                          <p class="sp-t-1-1">Умный шлагбаум — это сервис, который может автоматически распознавать
                            номера,
                            оформлять гостевые пропуска и с помощью push-уведомлений сообщать о прибывших гостях.</p>
                          <div class="sp-t-2"><p class="ld-key-boolet">Просмотр видео с камер шлагбаума онлайн</p></div>
                          <div class="sp-t-1"><p class="ld-key-boolet">Заказ гостевых пропусков через мобильное
                            приложение</p></div>
                          <div class="sp-t-1"><p class="ld-key-boolet">Автоматический пропуск спецтранспорта (скорая,
                            МЧС,
                            полиция)</p></div>
                          <div class="sp-t-1"><p class="ld-key-boolet">Отсутствие чужих машин во дворе решает проблему
                            отсутствия свободных парковочных мест </p></div>
                          <p class="rt-font-center color-purple rt-link ld-key-tab-show-less md-d-none d-none md-sp-t-1-1">Скрыть</p>
                        </div>
                      </div>
                    </div>
                    <div label="Умный домофон — новые возможности удобства для вашего дома"
                      ...
                      <div class="ld-key-tabs-slider-wrapper md-sp-t-1-1">
                        <div class="ld-key-tabs-slider-container sp-h-0-3 md-sp-h-2">
                          <div class="ld-key-tabs-slider-item ld-key-tabs-slider-item--active">
                            <p class="ld-key-slider-text">Управление через приложение</p>
                            <img
                                src="https://static-cdn.rt.ru/sites/default/files/img/rt-key/barrier-1.png" alt="">
                          </div>
                          <div class="ld-key-tabs-slider-item">
                            <p class="ld-key-slider-text">Распознавание номеров </p>
                            <img
                                src="https://static-cdn.rt.ru/sites/default/files/img/rt-key/barrier-2.png" alt="">
                          </div>
                          <div class="ld-key-tabs-slider-item">
                            <p class="ld-key-slider-text">Автоматический пропуск экстренных служб</p>
                            <img
                                src="https://static-cdn.rt.ru/sites/default/files/img/rt-key/barrier-3.png" alt="">
                          </div>
                        </div>
                        <div class="ld-key-tabs-paginator d-flex sp-t-1-2 md-d-none">
                          <div data-tab-index="2" data-slide-index="0"
                               class="ld-key-tabs-paginator-item ld-key-tabs-paginator-item--active flex-fill"></div>
                          <div data-tab-index="2" data-slide-index="1"
                               class="ld-key-tabs-paginator-item flex-fill"></div>
                          <div data-tab-index="2" data-slide-index="2"
                               class="ld-key-tabs-paginator-item flex-fill"></div>
                        </div>
                        <div class="ld-key-tabs-arrows d-flex sp-t-1-2 md-d-block d-none">
                          <div data-tab-index="2" class="ld-key-tabs-arrows-left ld-key-tabs-arrows-item">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M8.47115 11.4692L13.9711 5.99976L15.0289 7.06337L10.0636 12.001L15.0289 16.9387L13.9711 18.0023L8.47115 12.5328C8.32959 12.392 8.25 12.2007 8.25 12.001C8.25 11.8014 8.32959 11.61 8.47115 11.4692Z"
                          ...
                          <div data-tab-index="2" class="ld-key-tabs-arrows-right ld-key-tabs-arrows-item">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M15.5581 11.4692L10.0581 5.99976L9.00045 7.06337L13.9657 12.001L9.00045 16.9387L10.0581 18.0023L15.5581 12.5328C15.6997 12.392 15.7793 12.2007 15.7793 12.001C15.7793 11.8014 15.6997 11.61 15.5581 11.4692Z"
                  ...
                  <rt-row class="td-sp-t-2 row-md-reverse">
                    <div class="rt-col-persent-6 rt-col-td-4 rt-col-md-3 td-sp-r-5 md-sp-r-none">
                      <div class="sp-l-2-2 sp-t-2 td-sp-t-none td-sp-l-none md-sp-t-1-4 rt-font-small-paragraph">
                        ...
                        <div class="ld-key-tab-content sp-r-2-4 td-r-1 md-sp-r-none">
                          <p class="rt-font-h2 md-d-none">Умные счетчики — новые возможности вашего контроля</p>
                          <p class="sp-t-1-1 md-sp-t-4">«Умные» счетчики производят учет потребления электроэнергии,
                            воды, газа и
                            других ресурсов и самостоятельно передают данные в Управляющую кампанию.</p>
                          <div class="sp-t-2"><p class="ld-key-boolet">Оплата начислений по фактическому потреблению</p>
                          </div>
                          <div class="sp-t-1"><p class="ld-key-boolet">Не нужно тратить время на передачу показаний и
                            платить за недобросовестных соседей</p></div>
                          <div class="sp-t-1"><p class="ld-key-boolet">Управление потреблением: например, в случае
                            отпуска
                            вам не придется делать перерасчет, поскольку платеж будет автоматически снижен.</p></div>
                          <div class="sp-t-1"><p class="ld-key-boolet">Удобный доступ к статистике за любой период в
                            мобильном приложении</p></div>
                          <p class="rt-font-center color-purple rt-link ld-key-tab-show-less md-d-none d-none md-sp-t-1-1">Скрыть</p>
                        </div>
                      </div>
                    </div>
                    <div label="Умные счетчики — новые возможности вашего контроля"
                      ...
                      <div class="ld-key-tabs-slider-wrapper md-sp-t-1-1">
                        <div class="ld-key-tabs-slider-container sp-h-0-3 md-sp-h-2">
                          <div class="ld-key-tabs-slider-item ld-key-tabs-slider-item--active">
                            <p class="ld-key-slider-text">Автоматический сбор показаний</p>
                            <img
                                src="https://static-cdn.rt.ru/sites/default/files/img/rt-key/counter-1.png" alt="">
                          </div>
                          <div class="ld-key-tabs-slider-item">
                            <p class="ld-key-slider-text">Управление потреблением </p>
                            <img
                                src="https://static-cdn.rt.ru/sites/default/files/img/rt-key/counter-2.png" alt="">
                          </div>
                          <div class="ld-key-tabs-slider-item">
                            <p class="ld-key-slider-text">Удобный доступ к статистике </p>
                            <img
                                src="https://static-cdn.rt.ru/sites/default/files/img/rt-key/counter-3.png" alt="">
                          </div>
                        </div>
                        <div class="ld-key-tabs-paginator d-flex sp-t-1-2 md-d-none">
                          <div data-tab-index="3" data-slide-index="0"
                               class="ld-key-tabs-paginator-item ld-key-tabs-paginator-item--active flex-fill"></div>
                          <div data-tab-index="3" data-slide-index="1"
                               class="ld-key-tabs-paginator-item flex-fill"></div>
                          <div
                               class="flex-fill"></div>
                        </div>
                        <div class="ld-key-tabs-arrows d-flex sp-t-1-2 md-d-block d-none">
                          <div data-tab-index="3" class="ld-key-tabs-arrows-left ld-key-tabs-arrows-item">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M8.47115 11.4692L13.9711 5.99976L15.0289 7.06337L10.0636 12.001L15.0289 16.9387L13.9711 18.0023L8.47115 12.5328C8.32959 12.392 8.25 12.2007 8.25 12.001C8.25 11.8014 8.32959 11.61 8.47115 11.4692Z"
                          ...
                          <div data-tab-index="3" class="ld-key-tabs-arrows-right ld-key-tabs-arrows-item">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M15.5581 11.4692L10.0581 5.99976L9.00045 7.06337L13.9657 12.001L9.00045 16.9387L10.0581 18.0023L15.5581 12.5328C15.6997 12.392 15.7793 12.2007 15.7793 12.001C15.7793 11.8014 15.6997 11.61 15.5581 11.4692Z"
                  ...
                  <rt-row class="td-sp-t-2 row-md-reverse">
                    <div class="rt-col-persent-6 rt-col-td-4 rt-col-md-3 td-sp-r-5 md-sp-r-none">
                      <div class="sp-l-2-2 sp-t-2 td-sp-t-none td-sp-l-none md-sp-t-1-4 rt-font-small-paragraph">
                        ...
                        <div class="ld-key-tab-content sp-r-2-4 td-r-1 md-sp-r-none">
                          <p class="rt-font-h2 md-d-none">Умный доступ (СКУД) — новые возможности управления
                            доступом</p>
                          <p class="sp-t-1-1">СКУД — это комплексное решение для управления и контроля доступа во все
                            помещения и на территорию жилого комплекса.</p>
                          <div class="sp-t-2"><p class="ld-key-boolet">На территории дома только «свои». Доступ в места
                            общего пользования имеют только жильцы конкретного дома или подъезда. Ведется журнал
                            проходов
                            и
                            событий</p></div>
                          <div class="sp-t-1"><p class="ld-key-boolet">Жильцам легко пользоваться системой благодаря
                            использованию своего ключа от умного домофона или через приложение Ключ</p></div>
                          <div class="sp-t-1"><p class="ld-key-boolet">Сохранность личного имущества. Возможность
                            организовать безопасное хранение имущества в специально отведенных местах</p></div>
                          <p class="rt-font-center color-purple rt-link ld-key-tab-show-less md-d-none d-none md-sp-t-1-1">Скрыть</p>
                        </div>
                      </div>
                    </div>
                    <div label="Умный доступ (СКУД) — новые возможности управления доступом"
                      ...
                      <div class="ld-key-tabs-slider-wrapper md-sp-t-1-1">
                        <div class="ld-key-tabs-slider-container sp-h-0-3 md-sp-h-2">
                          <div class="ld-key-tabs-slider-item ld-key-tabs-slider-item--active">
                            <p class="ld-key-slider-text">Бесконтактный ключ</p>
                            <img
                                src="https://static-cdn.rt.ru/sites/default/files/img/rt-key/intercom-2" alt="">
                          </div>
                          <div class="ld-key-tabs-slider-item">
                            <p class="ld-key-slider-text">Удаленное открытие</p>
                            <img
                          ...
                          <div class="ld-key-tabs-slider-item">
                            <p class="ld-key-slider-text">Доступ к журналу событий</p>
                            <img
                                src="https://static-cdn.rt.ru/sites/default/files/img/rt-key/video-3.png" alt="">
                          </div>
                        </div>
                        <div class="ld-key-tabs-paginator d-flex sp-t-1-2 md-d-none">
                          <div data-tab-index="4" data-slide-index="0"
                               class="ld-key-tabs-paginator-item ld-key-tabs-paginator-item--active flex-fill"></div>
                          <div data-tab-index="4" data-slide-index="1"
                               class="ld-key-tabs-paginator-item flex-fill"></div>
                          <div data-tab-index="4" data-slide-index="2"
                               class="ld-key-tabs-paginator-item flex-fill"></div>
                        </div>
                        <div class="ld-key-tabs-arrows d-flex sp-t-1-2 md-d-block d-none">
                          <div data-tab-index="4" class="ld-key-tabs-arrows-left ld-key-tabs-arrows-item">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M8.47115 11.4692L13.9711 5.99976L15.0289 7.06337L10.0636 12.001L15.0289 16.9387L13.9711 18.0023L8.47115 12.5328C8.32959 12.392 8.25 12.2007 8.25 12.001C8.25 11.8014 8.32959 11.61 8.47115 11.4692Z"
                          ...
                          <div data-tab-index="4" class="ld-key-tabs-arrows-right ld-key-tabs-arrows-item">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M15.5581 11.4692L10.0581 5.99976L9.00045 7.06337L13.9657 12.001L9.00045 16.9387L10.0581 18.0023L15.5581 12.5328C15.6997 12.392 15.7793 12.2007 15.7793 12.001C15.7793 11.8014 15.6997 11.61 15.5581 11.4692Z"
    ...
    <div class="wc-inline">
      <div class="ld-key-gray sp-v-5 td-sp-v-3 md-sp-v-2">
      <div class="sp-v-1 td-sp-v-none">
        <div class="rt-container">
          <rt-col>
            <p class="rt-font-h2 sp-b-2 md-sp-b-1-2">Готовые решения для строительства и управления ЖК</p>
            <rt-row>
                    ...
                    <rt-row>
                      ...
                      <div class="rt-col-persent-5 relative rt-col-md-3 d-flex">
                        <div class="d-flex flex-column">
                          <div class="flex-fill">
                        <p class="rt-font-h4">Управляющая компания</p>
                        <p class="sp-t-1 color-main05 md-sp-b-1-1">Управление, обслуживание и контроль дома и территории 24 часа в
                          сутки</p>
            ...
            <rt-col :size="6" :tablet-size="3" :mobile-size="3" style="min-height:1000px">
              ...
              <rt-tabs :fill-Content="true">
                <template slot="navigation">
                  <rt-tabs-nav-item name="first">Для себя
                  </rt-tabs-nav-item>
                  <rt-tabs-nav-item anchor="one32" :remove-base-tag="true" name="second">Для ЖК или дома
                  </rt-tabs-nav-item>

                </template>
                <template slot="content">
                  <rt-tabs-content-item name="first">
                    <div class="sp-t-2">
                      <rt-button color="purple">Подать заявку</rt-button>
                    </div>
                  </rt-tabs-content-item>
                  <rt-tabs-content-item name="second">
                    <div class="sp-t-2">
                      <rt-button color="purple">Подать заявку</rt-button>
                    </div>
                  </rt-tabs-content-item>
            ...
            <rt-col :size="4" :tablet-size="3" :mobile-size="3" class="md-sp-t-2 d-flex td-d-block flex-v-center ">
              <div>
                ...
                <div class="d-flex td-d-block">
                  <div class="flex-fill sp-r-0-2 td-sp-r-none ld-key-apple">
                  ...
                  <div class="flex-fill sp-l-0-2 td-sp-l-none td-sp-t-1 ld-key-google">
                    <rt-button class="rt-button--is-block" href="#" color="black">
      ...
      if (!document.querySelector('.ld-key-slader-block .row .ld-key-tabs-item')) {
        ...
        var timer = function(){
          ...
          timeout = setTimeout(function (){
            ...
            tabsSliderActiveItems[activeSlideIndex] = (tabsSliderActiveItems[activeSlideIndex]+1)%slideSize;
