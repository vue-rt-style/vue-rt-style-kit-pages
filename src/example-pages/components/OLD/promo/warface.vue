            ...
            <div class="row">
              <div class="rt-col-12">
                <div class="flex-column d-space-between rt-fill-viewport-height rt-md-viewport-height-reset d-flex">
                  ...
                  <div class="flex-fill flex-start-center rt-md-space-top35">
                    <div class="flex-column rt-td-space-left rt-md-space-left-none md-flex-fill">
  ...
  export default {
    ...
    mounted() {
      ...
      var updatePaginator = function() {
        ...
        $(".rt-game-banner__item-container-data--is-active").classList.remove("rt-game-banner__item-container-data--is-active");
        $$(".rt-game-banner__paginator-item")[activeSlideIndex].classList.add("rt-game-banner__paginator-item--is-active");
        $$(".rt-game-banner__item-container-data")[activeSlideIndex].classList.add("rt-game-banner__item-container-data--is-active");
      };
      ...
      $(".game-item-open-one").addEventListener("click", function() {
        $$(".rt-game-banner__paginator-item")[0].click();
        $(".rt-go-to-banner").click();
      });
      $(".game-item-open-two").addEventListener("click", function() {
        $$(".rt-game-banner__paginator-item")[1].click();
        $(".rt-go-to-banner").click();
      });
      $(".game-item-open-tree").addEventListener("click", function() {
        $$(".rt-game-banner__paginator-item")[2].click();
        $(".rt-go-to-banner").click();
      });
    },
    created() {
