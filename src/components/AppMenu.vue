...
export default {
  ...
  render(h) {
    ...
    return <div class="app-aside-menu">
      <div class="app-aside-menu__wrapper">
        <div class="app-aside-menu__inner">
          <div class="app-aside-menu-header">
            {this.$slots.default}
            <div class="sp-h-1 rt-space-bottom app-aside-menu__search">
              <rt-input ref="input" placeholder="Seacrh" onInput={this.changeSearchParams}
                        onKeydown={this.checkKeydown}></rt-input>
            </div>
          </div>
