...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./src/example-pages/components/group/CarouselV2--demo.vue?vue&type=template&id=0bab2367&":
/*!******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/example-pages/components/group/CarouselV2--demo.vue?vue&type=template&id=0bab2367& ***!
  \******************************************************************************************************************************************************************************************************************************/
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._m(0),_vm._v(" "),_c('div',{staticClass:"sp-v-2"},[_c('div',{staticClass:"rt-container"},[_vm._m(1),_vm._v(" "),_c('div',{staticClass:"rt-col-12 rt-space-bottom3 is-b2c"},[_c('rt-row',[_c('rt-col',{attrs:{"size":"2"}},[_c('p',[_vm._v("background")]),_vm._v(" "),_c('select',{directives:[{name:"model",rawName:"v-model",value:(_vm.background),expression:"background"}],on:{"change":function($event){var $$selectedVal = Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val = "_value" in o ? o._value : o.value;return val}); _vm.background=$event.target.multiple ? $$selectedVal : $$selectedVal[0]}}},_vm._l((_vm.colors),function(i){return _c('option',{domProps:{"value":i}},[_vm._v(_vm._s(i))])}),0)]),_vm._v(" "),_c('rt-col',{attrs:{"size":"2"}},[_c('p',[_vm._v("shadowColor")]),_vm._v(" "),_c('select',{directives:[{name:"model",rawName:"v-model",value:(_vm.shadowColor),expression:"shadowColor"}],on:{"change":function($event){var $$selectedVal = Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val = "_value" in o ? o._value : o.value;return val}); _vm.shadowColor=$event.target.multiple ? $$selectedVal : $$selectedVal[0]}}},_vm._l((_vm.colors),function(i){return _c('option',{domProps:{"value":i}},[_vm._v(_vm._s(i))])}),0)]),_vm._v(" "),_c('rt-col',{attrs:{"size":"2"}},[_c('p',[_vm._v("show shadow")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.showShadow),expression:"showShadow"}],attrs:{"type":"checkbox"},domProps:{"checked":Array.isArray(_vm.showShadow)?_vm._i(_vm.showShadow,null)>-1:(_vm.showShadow)},on:{"change":function($event){var $$a=_vm.showShadow,$$el=$event.target,$$c=$$el.checked?(true):(false);if(Array.isArray($$a)){var $$v=null,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.showShadow=$$a.concat([$$v]))}else{$$i>-1&&(_vm.showShadow=$$a.slice(0,$$i).concat($$a.slice($$i+1)))}}else{_vm.showShadow=$$c}}}})]),_vm._v(" "),_c('rt-col',{attrs:{"size":"2"}},[_c('p',[_vm._v("infinite scroll")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.infinitescroll),expression:"infinitescroll"}],attrs:{"type":"checkbox"},domProps:{"checked":Array.isArray(_vm.infinitescroll)?_vm._i(_vm.infinitescroll,null)>-1:(_vm.infinitescroll)},on:{"change":function($event){var $$a=_vm.infinitescroll,$$el=$event.target,$$c=$$el.checked?(true):(false);if(Array.isArray($$a)){var $$v=null,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.infinitescroll=$$a.concat([$$v]))}else{$$i>-1&&(_vm.infinitescroll=$$a.slice(0,$$i).concat($$a.slice($$i+1)))}}else{_vm.infinitescroll=$$c}}}})]),_vm._v(" "),_c('rt-col',{attrs:{"size":"2"}},[_c('p',[_vm._v("blur not active")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.blurnotactive),expression:"blurnotactive"}],attrs:{"type":"checkbox"},domProps:{"checked":Array.isArray(_vm.blurnotactive)?_vm._i(_vm.blurnotactive,null)>-1:(_vm.blurnotactive)},on:{"change":function($event){var $$a=_vm.blurnotactive,$$el=$event.target,$$c=$$el.checked?(true):(false);if(Array.isArray($$a)){var $$v=null,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.blurnotactive=$$a.concat([$$v]))}else{$$i>-1&&(_vm.blurnotactive=$$a.slice(0,$$i).concat($$a.slice($$i+1)))}}else{_vm.blurnotactive=$$c}}}})]),_vm._v(" "),_c('rt-col',{attrs:{"size":"2"}},[_c('p',[_vm._v("scrollable on desktop")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.scrollableondesktop),expression:"scrollableondesktop"}],attrs:{"type":"checkbox"},domProps:{"checked":Array.isArray(_vm.scrollableondesktop)?_vm._i(_vm.scrollableondesktop,null)>-1:(_vm.scrollableondesktop)},on:{"change":function($event){var $$a=_vm.scrollableondesktop,$$el=$event.target,$$c=$$el.checked?(true):(false);if(Array.isArray($$a)){var $$v=null,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.scrollableondesktop=$$a.concat([$$v]))}else{$$i>-1&&(_vm.scrollableondesktop=$$a.slice(0,$$i).concat($$a.slice($$i+1)))}}else{_vm.scrollableondesktop=$$c}}}})]),_vm._v(" "),_c('rt-col',{attrs:{"size":"2"}},[_c('p',[_vm._v("col in row")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.colInRow),expression:"colInRow"}],attrs:{"type":"number"},domProps:{"value":(_vm.colInRow)},on:{"input":function($event){if($event.target.composing){ return; }_vm.colInRow=$event.target.value}}})]),_vm._v(" "),_c('rt-col',{attrs:{"size":"2"}},[_c('p',[_vm._v("laptop col in row")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.laptopColInRow),expression:"laptopColInRow"}],attrs:{"type":"number"},domProps:{"value":(_vm.laptopColInRow)},on:{"input":function($event){if($event.target.composing){ return; }_vm.laptopColInRow=$event.target.value}}})])],1)],1)]),_vm._v(" "),_c('rt-carousel-v3',{attrs:{"background":_vm.background,"shadow-color":_vm.shadowColor,"show-shadow":_vm.showShadow,"infinite-scroll":_vm.infinitescroll,"blur-not-active":_vm.blurnotactive,"col-in-row":_vm.colInRow,"laptop-col-in-row":_vm.laptopColInRow,"scrollable-on-desktop":_vm.scrollableondesktop}},_vm._l((10),function(i){return _c('pre-timeout',{key:i,attrs:{"time":i*1000}},[_c('rt-carousel-slide-v3',[_c('div',[_c('div',{staticStyle:{"background-size":"cover","border-radius":"8px","height":"300px","position":"relative"},style:(("background: url(https://picsum.photos/500/300?getForId=" + i + ")"))},[_c('div',{staticStyle:{"background-color":"black","color":"white","position":"absolute","bottom":"0","right":"0","padding":"0 10px"},domProps:{"textContent":_vm._s(i)}})])])])],1)}),1),_vm._v(" "),_c('rt-carousel-v3',{attrs:{"background":_vm.background,"shadow-color":_vm.shadowColor,"show-shadow":_vm.showShadow,"infinite-scroll":_vm.infinitescroll,"blur-not-active":_vm.blurnotactive,"scrollable-on-desktop":_vm.scrollableondesktop}},_vm._l((10),function(i){return _c('rt-carousel-slide-v3',{key:i,attrs:{"time":i*1000}},[_c('div',[_c('div',{staticStyle:{"background-size":"cover","border-radius":"8px","height":"300px","position":"relative"},style:(("background: url(https://picsum.photos/500/300?getForId=" + i + ")"))},[_c('div',{staticStyle:{"background-color":"black","color":"white","position":"absolute","bottom":"0","right":"0","padding":"0 10px"},domProps:{"textContent":_vm._s(i)}})])])])}),1)],1),_vm._v(" "),_c('div',{staticClass:"rt-container"})])}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _CarouselV2_demo_vue_vue_type_template_id_0bab2367___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CarouselV2--demo.vue?vue&type=template&id=0bab2367& */ "./src/example-pages/components/group/CarouselV2--demo.vue?vue&type=template&id=0bab2367&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _CarouselV2_demo_vue_vue_type_template_id_0bab2367___WEBPACK_IMPORTED_MODULE_0__["render"],
  _CarouselV2_demo_vue_vue_type_template_id_0bab2367___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/***/ "./src/example-pages/components/group/CarouselV2--demo.vue?vue&type=template&id=0bab2367&":
/*!************************************************************************************************!*\
  !*** ./src/example-pages/components/group/CarouselV2--demo.vue?vue&type=template&id=0bab2367& ***!
  \************************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_CarouselV2_demo_vue_vue_type_template_id_0bab2367___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./CarouselV2--demo.vue?vue&type=template&id=0bab2367& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./src/example-pages/components/group/CarouselV2--demo.vue?vue&type=template&id=0bab2367&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_CarouselV2_demo_vue_vue_type_template_id_0bab2367___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_CarouselV2_demo_vue_vue_type_template_id_0bab2367___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
