...
/* harmony export */   "RtSwipeRight": () => (/* reexport safe */ _Swipe_swipe__WEBPACK_IMPORTED_MODULE_6__["default"]),
...
/* harmony export */ });
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-rt-style-kit-atoms'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var vue_rt_style_kit_atoms_src_variables_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vue-rt-style-kit-atoms/src/variables.json */ "./src/atoms/variables.json");
/* harmony import */ var _directives__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./directives */ "./src/molecules/directives/index.js");
...
console.info('StorePrototype', Object(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-rt-style-kit-atoms'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
var directives = _objectSpread({}, _directives__WEBPACK_IMPORTED_MODULE_2__);
/**
...
var skeleton = function skeleton(heights) {
  var normalizeBpSize = function normalizeBpSize(bp) {
    return parseInt(vue_rt_style_kit_atoms_src_variables_json__WEBPACK_IMPORTED_MODULE_1__[bp], 10);
  };
